  ...
  (
    ...
    return (
      <div
        ...
        data-state={state}
        className={cn(
            "hidden md:flex flex-col bg-background border-r transition-[width] duration-300 ease-in-out",
...
>(({ className, label, children, ...props }, ref) => {
    ...
    return (
        <div ref={ref} className={cn("p-2", className)} {...props}>
            <p className={cn(
                "px-2 text-xs font-semibold uppercase text-muted-foreground tracking-wider transition-opacity duration-300",
