  ...
  (
    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            side={side}
            // UPDATED: Changed background to be semi-transparent with blur
            className="w-[--sidebar-width] bg-background/80 backdrop-blur-lg p-0 [&>button]:hidden"
    ...
    return (
      <div
        ...
        data-state={state}
        className={cn(
            // UPDATED: Added glassmorphism effect to desktop sidebar
            "hidden md:flex flex-col bg-background/50 backdrop-blur-xl border-r transition-[width] duration-300 ease-in-out",
